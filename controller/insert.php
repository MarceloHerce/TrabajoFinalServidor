...
//     $products = [
//         // pc parts
//         ["Cable", "High-quality cable for various connections", 5.99, 100, "src/cable_image", 1],
//         ["Case", "Sturdy computer case for optimal protection", 39.99, 20, "src/case_image", 1],
//         ["Tower case", "Sleek tower case with ample space for components", 89.99, 15, "src/tower_case_image", 1],
//         ["Power supply", "Reliable power supply for consistent performance", 49.99, 30, "src/power_supply_image", 1],
//         ["Plug", "Universal plug for seamless connectivity", 2.99, 200, "src/plug_image", 1],
//         ["Switch", "Efficient network switch for fast data transfer", 29.99, 10, "src/switch_image", 1],
//         ["Optical drive", "Versatile optical drive for reading and writing discs", 34.99, 25, "src/optical_drive_image", 1],
//         ["Input/output adapter", "Adaptable adapter for diverse input/output needs", 12.99, 50, "src/io_adapter_image", 1],
...
//         ["Fan", "Keep your system cool and efficient with powerful fans", 12.99, 25, "src/fan", 1],
//         ["Hard disk drive", "Store large amounts of data with reliable hard disk drives", 59.99, 10, "src/hard_disk_drive", 1],
//         ["Heat sink", "Maintain optimal temperature with effective heat sinks", 9.99, 30, "src/heat_sink", 1],
...
//         ["Monitor", "Vibrant display for immersive visual experience", 149.99, 20, "src/monitor", 2],
//         ["Mouse", "Precision and comfort in a sleek design", 19.99, 50, "src/mouse", 2],
...
//         ["Headphones", "High-quality headphones for immersive audio", 49.99, 25, "src/headphones", 2],
...
//         ["Speakers", "Powerful speakers for immersive audio experience", 59.99, 18, "src/speakers", 2],
